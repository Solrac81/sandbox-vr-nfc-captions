...
**Printable QR:** [`qr.png`](./qr.png) · [`qr.svg`](./qr.svg) · [`qr.html`](./qr.html) (preview / download)  
...
| `qr.png` | Printable QR PNG |
| `qr.svg` | Printable QR SVG (vector) |
| `qr.html` | Preview + download qr.png |
| `qr.png.b64` | ASCII base64 of qr.png (MCP-safe source) |
...
1. Deploy (or use) the HTTPS URL:  
   `https://solrac81.github.io/sandbox-vr-nfc-captions/`
2. **Printable QR is in the repo:** [`qr.png`](./qr.png) and [`qr.svg`](./qr.svg) (or open [`qr.html`](./qr.html) to preview / download)  
   Raw PNG: https://raw.githubusercontent.com/Solrac81/sandbox-vr-nfc-captions/main/qr.png  
   Raw SVG: https://raw.githubusercontent.com/Solrac81/sandbox-vr-nfc-captions/main/qr.svg  
